...
java7 -jar /opt/GATK/GATK2.6/GenomeAnalysisTK.jar -T RealignerTargetCreator -R /media/InternBkp1/repos/refs/Sus_scrofa.Sscrofa10.2.72.dna.toplevel.fa -I tmpBS01F10/BS01F10_rh.dedup_st.bam -o tmpBS01F10/BS01F10_rh.dedup_st.reA.intervals
...
java7 -jar /opt/GATK/GATK2.6/GenomeAnalysisTK.jar -T BaseRecalibrator -R /media/InternBkp1/repos/refs/Sus_scrofa.Sscrofa10.2.72.dna.toplevel.fa -I tmpBS01F10/BS01F10_rh.dedup_st.reA.bam -knownSites /media/InternBkp1/repos/dbSNP/Ssc_dbSNP138.vcf -o tmpBS01F10/BS01F10_rh.dedup_st.reA.recal.grp
java7 -jar /opt/GATK/GATK2.6/GenomeAnalysisTK.jar -T PrintReads -R /media/InternBkp1/repos/refs/Sus_scrofa.Sscrofa10.2.72.dna.toplevel.fa -I tmpBS01F10/BS01F10_rh.dedup_st.reA.bam -BQSR tmpBS01F10/BS01F10_rh.dedup_st.reA.recal.grp -o tmpBS01F10/BS01F10_rh.dedup_st.reA.recal.bam
