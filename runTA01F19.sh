...
java7 -Xmx4g -jar /opt/picard/picard-tools-1.93/MarkDuplicates.jar MAX_RECORDS_IN_RAM=5000000 ASSUME_SORTED=true REMOVE_DUPLICATES=true INPUT=tmpTA01F19/TA01F19_rh.bam OUTPUT=tmpTA01F19/TA01F19_rh.dedup_pi.bam METRICS_FILE=tmpTA01F19/TA01F19_rh.dedup.metrics
...
/opt/samtools/samtools-0.1.19/samtools index tmpTA01F19/TA01F19_rh.dedup_pi.bam
...
java7 -jar /opt/GATK/GATK2.6/GenomeAnalysisTK.jar -T BaseRecalibrator -R /media/InternBkp1/repos/refs/Sus_scrofa.Sscrofa10.2.72.dna.toplevel.fa -I tmpTA01F19/TA01F19_rh.dedup_pi.reA.bam -knownSites /media/InternBkp1/repos/dbSNP/Ssc_dbSNP138.vcf -o tmpTA01F19/TA01F19_rh.dedup_pi.reA.recal.grp
java7 -jar /opt/GATK/GATK2.6/GenomeAnalysisTK.jar -T PrintReads -R /media/InternBkp1/repos/refs/Sus_scrofa.Sscrofa10.2.72.dna.toplevel.fa -I tmpTA01F19/TA01F19_rh.dedup_pi.reA.bam -BQSR tmpTA01F19/TA01F19_rh.dedup_pi.reA.recal.grp -o tmpTA01F19/TA01F19_rh.dedup_pi.reA.recal.bam
...
java7 -jar /opt/GATK/GATK2.6/GenomeAnalysisTK.jar -R /media/InternBkp1/repos/refs/Sus_scrofa.Sscrofa10.2.72.dna.toplevel.fa -T UnifiedGenotyper -I tmpTA01F19/TA01F19_rh.dedup_pi.reA.recal.bam --dbsnp /media/InternBkp1/repos/dbSNP/Ssc_dbSNP138.vcf --genotype_likelihoods_model BOTH -o tmpTA01F19/TA01F19_rh.dedup_pi.reA.recal.UG.raw.vcf  -stand_call_conf 50.0 -stand_emit_conf 10.0  -dcov 50
