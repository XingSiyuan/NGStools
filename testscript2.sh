...
/opt/samtools/samtools-0.1.12/samtools view -u tmpLW22F08/LW22F08_rh.bam | /opt/samtools/samtools-0.1.12/samtools pileup -vcf /media/InternBkp1/repos/refs/Sus_scrofa.Sscrofa10.2.72.dna.toplevel.fa - >tmpLW22F08/LW22F08_rh_vars-raw.txt
/opt/samtools/samtools-0.1.12/samtools.pl varFilter -D20 tmpLW22F08/LW22F08_rh_vars-raw.txt | awk '($3=="*"&&$6>=50)||($3!="*"&&$6>=20)' >tmpLW22F08/LW22F08_rh_vars-flt_final.txt
